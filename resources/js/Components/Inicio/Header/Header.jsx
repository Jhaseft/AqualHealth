    ...
    const menuItems = [
        ...
        },
        {
        ...
        },
         {
            ...
            link: "#",
            submenu: [
                { name: "INGENIERÍA & CONSULTORÍA", link: "/Ingenieria-Consultoria" },
                { name: "PLANTAS & EQUIPOS", link: "/Plantas-Equipos" },
                { name: "ARMO QUIMICA", link: "/Armo-Quimica" },
                { name: "PRODUCTOS QUÍMICOS", link: "/Productos-Quimicos" },
                { name: "CAPACITACIÓN & ENTRENAMIENTO", link: "/Capacitacion-Entrenamiento" },
            ],
        },
