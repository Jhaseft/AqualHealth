...
export default function PlantsEquipmentPrincipal() {
    ...
    const sections = [
        {
            ...
            paragraphs: [
                ...
                '<li>Filtros de Arena – Carbón Activado</li>',
            ...
            logo: {
                src: "https://res.cloudinary.com/dcyx3nqj5/image/upload/v1761697392/Captura_de_pantalla_2025-10-28_202300_qnraub.jpg",
                alt: "Aqual Health",
