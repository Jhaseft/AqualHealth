...
export default function Header() {
  ...
  return (
    <header className="bg-white/90 backdrop-blur-sm fixed top-0 left-0 w-full shadow-md ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-">
        {/* Logo */}
        <a href="/" className="flex items-center">
          <img
            src="https://www.aquahealth.com.tr/images/core-images/aquahealth-logo-social-tag.png"
            alt="Logo"
